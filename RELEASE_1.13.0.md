...
สองอย่างที่ไม่เคยมีมาก่อน ไม่ใช่ตัวแก้บั๊ก และเลข build ขึ้นเป็น 44 เสมอไม่ว่าจะ
เกิดอะไรขึ้นกับ 43 บน App Store Connect — เลข build ที่เคยอัปโหลดไปแล้วใช้ซ้ำไม่ได้
แม้จะยกเลิกการส่งตรวจไปแล้วก็ตาม
